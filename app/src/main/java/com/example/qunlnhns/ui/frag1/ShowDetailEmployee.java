...
public class ShowDetailEmployee extends Fragment {

    private TextView save, luong, title;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final NhanVien nhanVien = (NhanVien) bundle.getSerializable("passedNhanVien");


        // không pass nhân viên được
        if(nhanVien == null){
            return view;
        }
        ...
        title.setText("Thông tin chi tiết");
        maNV.setVisibility(View.GONE);
        ...
        heSoLuong.setText(String.valueOf( nhanVien.getHeSoLuong() ) );

        luong.setText("Lương: "+ nhanVien.getLuong());
        ...
        // set right-value to spinner

        spinnerCV.setSelection( listCV.indexOf(nhanVien.getMaCV()) );
        spinnerDA.setSelection( listDA.indexOf(nhanVien.getMaDA()) );
        spinnerPB.setSelection( listPB.indexOf(nhanVien.getMaPB()) );
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NhanVien newNhanVien = new NhanVien(nhanVien.getMaNV()
                ...
                DbEmployeeManager.getInstance(getContext()).modifyRow(newNhanVien, nhanVien.getMaNV());
    ...
    private void initView(View view) {
        ...
        title = view.findViewById(R.id.title_employ);
